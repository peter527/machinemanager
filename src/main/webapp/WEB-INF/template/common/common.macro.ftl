...
<#-- handlebars -->
<script src="${request.contextPath}/static/plugins/handlebars/handlebars-v4.0.11.js"></script>
...
<header class="main-header">
    <a href="${request.contextPath}/" class="logo">
        <span class="logo-mini"><b>科度</b></span>
        <span class="logo-lg"><b>人脸机器管理平台</b></span>
    </a>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="header">人脸设备</li>
            <li class="nav-click <#if pageName == "machine-info">active</#if>"><a href="${request.contextPath}/machine-info"><i class="fa fa-circle-o text-aqua"></i><span>设备分布</span></a></li>
            <li class="nav-click <#if pageName == "machine-manager">active</#if>"><a href="${request.contextPath}/machine-manager"><i class="fa fa-circle-o text-yellow"></i><span>设备管理</span></a></li>
        </ul>
        <ul class="sidebar-menu">
            <li class="header">数据字典</li>
            <li class="nav-click <#if pageName == "staff">active</#if>"><a href="${request.contextPath}/staff"><i class="fa fa-circle-o text-yellow"></i><span>人员配置</span></a></li>
            <li class="nav-click <#if pageName == "factory">active</#if>"><a href="${request.contextPath}/factory"><i class="fa fa-circle-o text-gray"></i><span>厂商配置</span></a></li>
            <li class="nav-click <#if pageName == "machine">active</#if>"><a href="${request.contextPath}/machine"><i class="fa fa-circle-o text-aqua"></i><span>设备型号</span></a></li>
            <li class="nav-click <#if pageName == "project">active</#if>"><a href="${request.contextPath}/project"><i class="fa fa-circle-o text-blue"></i><span>项目类型</span></a></li>
            <li class="nav-click <#if pageName == "location">active</#if>"><a href="${request.contextPath}/location"><i class="fa fa-circle-o text-green"></i><span>项目地点</span></a></li>
        </ul>
    </section>
    <!-- /.sidebar -->
</aside>
...
<footer class="main-footer">
    ...
    <div class="pull-right hidden-xs">
        <strong>Copyright &copy; 2015-${.now?string('yyyy')} &nbsp;
            <a href="http://www.ketech.com.cn" target="_blank">杭州科度科技有限公司</a>
